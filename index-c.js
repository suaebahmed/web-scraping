...
const saveCaterers = (baseURL, fileName, folderName) =>{
  ...
  (async () => {
    ...
    const scrapingData1 = await page.evaluate(() => {
      ...
      var item = document.querySelectorAll("table:nth-of-type(12) div#header");
      if(item.length == 0) item = document.querySelectorAll("table:nth-of-type(11) div#header");
    ...
    fs.writeFileSync(`data/${folderName}/Caterers-Data-${fileName}.csv`, csv); 
    await browser.close();
  })();
}

module.exports = saveCaterers;